...
LOCK TABLES `signup_user` WRITE;
/*!40000 ALTER TABLE `signup_user` DISABLE KEYS */;
INSERT INTO `signup_user` VALUES ('AZIZ','AZIZ'),('maruf','123'),('tushar','mdihtushar');
/*!40000 ALTER TABLE `signup_user` ENABLE KEYS */;
UNLOCK TABLES;
