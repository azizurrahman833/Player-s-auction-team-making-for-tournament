...
CREATE TABLE `team_info` (
  ...
  `team_sponser` varchar(100) NOT NULL,
...
INSERT INTO `team_info` VALUES ('cse1','emon','fanta','farhan'),('cse2','lammim','ring','shah'),('cse3','masum','bookreader','hasan'),('cse4','mahfuj','bikebd','rahman'),('cse5','anisur','pulserbd','anis rahman'),('cse6','jamil','footbalchamp','hossain');
